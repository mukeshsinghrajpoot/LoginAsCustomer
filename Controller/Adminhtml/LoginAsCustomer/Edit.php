...
class Edit extends \Bluethinkinc\LoginAsCustomer\Controller\Adminhtml\LoginAsCustomer
{
    /**
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('bluethinkinc_loginascustomer_loginascustomer', $model);
        
        // 3. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultPageFactory->create();
        $this->initPage($resultPage)->addBreadcrumb(
            $id ? __('Edit Loginascustomer') : __('New Loginascustomer'),
            $id ? __('Edit Loginascustomer') : __('New Loginascustomer')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Loginascustomers'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ?
        __('Edit Loginascustomer %1', $model->getId()) : __('New Loginascustomer'));
        return $resultPage;
    }
}
